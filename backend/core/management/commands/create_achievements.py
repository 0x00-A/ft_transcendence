    ...
    def handle(self, *args, **kwargs):
        achievements = [
            {"name": "First Paddle", "description": "Win your first match.",
                "image": "/icons/first_paddle.png", "threshold": 1, "condition": {"games_won": 1}},
            {"name": "Persistent Player", "description": "Log in 7 days in a row!",
                "image": "/icons/rookie.png", "threshold": 7, "condition": {"logins": 7}},
            {"name": "Bronze Champ", "description": "Win 5 matches.",
                "image": "/icons/bronze_champ.png", "threshold": 5, "condition": {"games_won": 5}},
